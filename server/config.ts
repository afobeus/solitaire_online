...
export const config = {
  ...
  mapSize: integer("MAP_SIZE", 12, 8, 20),
  vision: integer("VISION_RADIUS", 3, 1, 20),
  lootCount: integer("LOOT_COUNT", 24, 3, 100),
  ...
  zoneStages: JSON.parse(
    process.env.ZONE_STAGES ??
      '[{"afterMs":60000,"inset":1},{"afterMs":120000,"inset":2},{"afterMs":180000,"inset":3},{"afterMs":240000,"inset":4},{"afterMs":300000,"inset":5,"final":true}]',
